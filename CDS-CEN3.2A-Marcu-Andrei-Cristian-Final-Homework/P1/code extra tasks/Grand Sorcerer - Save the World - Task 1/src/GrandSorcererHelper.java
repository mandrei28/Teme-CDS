 ...
 * Creates the demonRetire thread and starts it
 * @author marcu
 */
public class GrandSorcererHelper {
	GrandSorcerer grandSorcerer;
	DemonSpawner demonSpawners[];
	DemonRetire demonRetire;
	volatile Semaphore demonRetireSemaphore = new Semaphore(0); // used for demon retirement
	
	/**
	 * Creates the demon spawners and starts them
	 * Creates the demon retire thread and starts it
	...
	GrandSorcererHelper(GrandSorcerer grandSorcerer)
	{
		...
		this.demonRetire = new DemonRetire(this);
		this.demonRetire.start();// we start the demon retire thread
	}
}
